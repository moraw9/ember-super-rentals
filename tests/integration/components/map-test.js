...
module('Integration | Component | map', function(hooks) {
  ...
  test('it renders a map image for the specialized parameters', async function(assert) {
  ...
  test('it updates the `src` attribute when the arguents change', async function(assert){
    ...
    assert.ok(
      img.src.includes('-122.4149,37.7749,10'),
      'the src should incude the lng,lat,zoom parameter 1'
    );
    ...
    assert.ok(
      img.src.includes('-122.4149,37.7749,12'),
      'the src should incude the lng,lat,zoom parameter 2'
    );
    ...
    assert.ok(
      ...
      'the src should incude the lng,lat,zoom parameter 3'
    );
