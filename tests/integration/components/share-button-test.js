...
module('Integration | Component | share-button', function(hooks) {
 ...
 test('it suppoerts passing @text', async function(assert){
 ...
 test('it suppoerts passing @hashtags', async function(assert){
 ...
 test('it suppoet passing @via', async function(assert){
